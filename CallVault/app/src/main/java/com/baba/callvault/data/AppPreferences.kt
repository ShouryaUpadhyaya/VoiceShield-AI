...
class AppPreferences(context: Context) {
    ...
    object DefaultsValue {
        ...
        // --- Media Gateway ---
        const val MEDIA_GATEWAY_ENABLED = false
        const val MEDIA_GATEWAY_URL = "ws://127.0.0.1:8010"
    ...
    enum class Key(val id: String) {
        ...
        // --- Media Gateway ---
        MEDIA_GATEWAY_ENABLED("media_gateway_enabled"),
        MEDIA_GATEWAY_URL("media_gateway_url"),
    ...
    /** Checks if Media Gateway streaming is enabled. */
    fun isMediaGatewayEnabled() = getBoolean(Key.MEDIA_GATEWAY_ENABLED, DefaultsValue.MEDIA_GATEWAY_ENABLED)

    /** Sets whether Media Gateway streaming is enabled. */
    fun setMediaGatewayEnabled(enabled: Boolean) = setBoolean(Key.MEDIA_GATEWAY_ENABLED, enabled)

    /** Gets the Media Gateway WebSocket URL. */
    fun getMediaGatewayUrl() = getString(Key.MEDIA_GATEWAY_URL, DefaultsValue.MEDIA_GATEWAY_URL) ?: DefaultsValue.MEDIA_GATEWAY_URL

    /** Sets the Media Gateway WebSocket URL. */
    fun setMediaGatewayUrl(url: String) = setString(Key.MEDIA_GATEWAY_URL, url)
